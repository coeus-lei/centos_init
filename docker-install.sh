...
if ! which docker-compose >/dev/null 2>&1; then curl -Lk https://raw.githubusercontent.com/coeus-lei/centos_init/master/docker-compose?token=AKA3FYSBDLG3W67R7FLSO3K6MMBJI|bash; fi
